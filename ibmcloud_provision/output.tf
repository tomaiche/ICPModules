...
output "ipv4" {
                value = "${var.private_ip_only == "true" ? ibm_compute_vm_instance.softlayer_virtual_guest.*.ipv4_address_private : ibm_compute_vm_instance.softlayer_virtual_guest.*.ipv4_address}" 
